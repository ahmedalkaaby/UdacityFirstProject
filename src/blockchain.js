...
class Blockchain {
  ...
  getBlockByHash(hash) {
    let self = this;
    return new Promise((resolve, reject) => {
      let hashTest = self.chain.find(f => f.hash === hash);
      if (hashTest) {
        resolve(hashTest);
      } else {
        reject("NO BLOCK HAS BEEN FOUND!!");
      }
    });
  }
  ...
  getBlockByHeight(height) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (block) {
        ...
        resolve("NO BLOCK HAS BEEN FOUND!!");
      }
    });
  }
  ...
  validateChain() {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (errorLog.length > 0) {
        resolve("THERE ARE ERRORS => " + errorLog);
      }
      reject("NO ERRORS WERE FOUND :)");
    });
  }
}
